        ...
        <div className="hs-carousel relative overflow-hidden w-full h-full">
          <div className="hs-carousel-body w-full absolute top-0 bottom-0 start-0 flex flex-nowrap duration-700 ease-in-out delay-200 opacity-0">
            ...
            <SlideBackground bgImage={'/assets/slider_bg_4.jpg'}>
              <div className="w-full flex flex-col justify-center text-center h-[90vh] absolute z-10">
                <span className="font-nothingYouCouldDo text-primary text-[40px] mb-4">Welcome</span>
                <h1 className="mb-8 text-[40px]">Crafted with Love, <span className='block'>Baked to Perfection</span></h1>
                <h3 className="mb-16">Indulge in artisanal pizzas made from the freshest ingredients—flavor that speaks for itself.</h3>
            ...
            <SlideBackground bgImage={'/assets/slider_bg_2.jpg'}>
              <div className="w-full flex flex-row gap-6 justify-center items-center h-full absolute z-10">
                ...
                <div className='max-w-xl ml-6'>
                  ...
                  <h1 className="mb-8 text-[40px]">Authentic Italian Pizza</h1>
                  <h3 className="mb-16">A true taste of Italy in every bite—crispy crusts, rich sauces, and unforgettable toppings.</h3>
            ...
            <SlideBackground bgImage={'/assets/slider_bg_2.jpg'}>
              <div className="w-full flex flex-row gap-6 justify-center items-center h-full absolute z-10">
                <div className='max-w-xl text-end mr-6'>
                  ...
                  <h1 className="mb-8 text-[40px]">Savor the Flavors of Italy</h1>
                  <h3 className="mb-16">From classic Margheritas to bold new creations—experience the passion behind every slice.</h3>
